...
int _todoItemEstimateSize(
  ...
  bytesCount += 3 + object.decription.length * 3;
...
TodoItem _todoItemDeserialize(
  ...
  final object = TodoItem(
    ...
    decription: reader.readString(offsets[1]),
    id: id,
...
extension TodoItemQueryFilter
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> decriptionEqualTo(
    String value, {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> decriptionGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> decriptionLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> decriptionBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> decriptionStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> decriptionEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> decriptionContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> decriptionMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> decriptionIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'decription',
        value: '',
...
extension TodoItemQuerySortBy on QueryBuilder<TodoItem, TodoItem, QSortBy> {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterSortBy> sortByDecription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'decription', Sort.asc);
    });
  }

  QueryBuilder<TodoItem, TodoItem, QAfterSortBy> sortByDecriptionDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoItemQuerySortThenBy
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterSortBy> thenByDecription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'decription', Sort.asc);
    });
  }

  QueryBuilder<TodoItem, TodoItem, QAfterSortBy> thenByDecriptionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'decription', Sort.desc);
    });
  }
...
extension TodoItemQueryWhereDistinct
  ...
  QueryBuilder<TodoItem, TodoItem, QDistinct> distinctByDecription(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TodoItemQueryProperty
  ...
  QueryBuilder<TodoItem, String, QQueryOperations> decriptionProperty() {
    return QueryBuilder.apply(this, (query) {
